...
<html lang="vi" prefix="og: https://ogp.me/ns#">
 <!-- Mirrored from www.greenfeed.com.vn/dieu-khoan-su-dung/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Nov 2025 06:08:06 GMT -->
 <!-- Added by HTTrack -->
 ...
 <head>
  ...
  <link href="../en/terms-and-conditions/index.php" hreflang="en" rel="alternate"/>
  <!-- Search Engine Optimization by Rank Math PRO - https://s.rankmath.com/home -->
  <title>
   Điều khoản sử dụng - GREENFEED Việt Nam
  </title>
  <meta content="Điều khoản sử dụng tại GREENFEED quy định rõ quyền, trách nhiệm và giới hạn pháp lý giữa người dùng và website, nhằm đảm bảo tính minh bạch và tuân thủ luật pháp." name="description"/>
  <meta content="follow, index, max-snippet:-1, max-video-preview:-1, max-image-preview:large" name="robots"/>
  <link href="index.php" rel="canonical"/>
  <meta content="vi_VN" property="og:locale">
   <meta content="article" property="og:type">
    <meta content="Điều khoản sử dụng - GREENFEED Việt Nam" property="og:title"/>
    <meta content="Điều khoản sử dụng tại GREENFEED quy định rõ quyền, trách nhiệm và giới hạn pháp lý giữa người dùng và website, nhằm đảm bảo tính minh bạch và tuân thủ luật pháp." property="og:description"/>
    <meta content="https://www.greenfeed.com.vn/dieu-khoan-su-dung/" property="og:url"/>
    ...
    <meta content="2025-06-09T18:18:38+07:00" property="og:updated_time"/>
    ...
    <meta content="Điều khoản sử dụng" property="og:image:alt"/>
    <meta content="image/jpeg" property="og:image:type"/>
    <meta content="summary_large_image" name="twitter:card"/>
    <meta content="Điều khoản sử dụng - GREENFEED Việt Nam" name="twitter:title"/>
    <meta content="Điều khoản sử dụng tại GREENFEED quy định rõ quyền, trách nhiệm và giới hạn pháp lý giữa người dùng và website, nhằm đảm bảo tính minh bạch và tuân thủ luật pháp." name="twitter:description"/>
...
:root :where(.wp-block-pullquote){font-size: 1.5em;line-height: 1.6;}
    ...
    <link href="https://www.greenfeed.com.vn/wp-json/wp/v2/pages/151" rel="alternate" title="JSON" type="application/json"/>
    ...
    <link href="../indexe539.php?p=151" rel="shortlink"/>
    <link href="https://www.greenfeed.com.vn/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwww.greenfeed.com.vn%2Fdieu-khoan-su-dung%2F" rel="alternate" title="oNhúng (JSON)" type="application/json+oembed"/>
    <link href="https://www.greenfeed.com.vn/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwww.greenfeed.com.vn%2Fdieu-khoan-su-dung%2F&amp;format=xml" rel="alternate" title="oNhúng (XML)" type="text/xml+oembed"/>
 ...
 <body class="wp-singular page-template-default page page-id-151 wp-theme-greenfeed loading-effect fade-in">
  <!-- <style type="text/css">
    /*Quốc tang*/
     ...
     <div class="header-main">
      ...
      <div class="dt-main-menu">
       ...
       <div class="header-utility__language">
        <a href="../en/terms-and-conditions/index.php">
    ...
    <div class="container">
     <div class="page-content-box">
      <div class="post-content">
       <article class="w-full text-token-text-primary focus-visible:outline-2 focus-visible:outline-offset-[-4px]" data-scroll-anchor="true" data-testid="conversation-turn-85" dir="auto">
        <div class="text-base my-auto mx-auto py-[18px] px-6">
         <div class="mx-auto flex flex-1 text-base gap-4 md:gap-5 lg:gap-6 md:max-w-3xl lg:max-w-[40rem] xl:max-w-[48rem]">
          <div class="group/conversation-turn relative flex w-full min-w-0 flex-col agent-turn @xs/thread:px-0 @sm/thread:px-1.5 @md/thread:px-4">
           <div class="flex-col gap-1 md:gap-3">
            <div class="flex max-w-full flex-col flex-grow">
             <div class="min-h-8 text-message relative flex w-full flex-col items-end gap-2 whitespace-normal break-words text-start [.text-message+&amp;]:mt-5" data-message-author-role="assistant" data-message-id="a5b44ad1-1ec1-42fe-81e4-b1169e517b4b" data-message-model-slug="gpt-4o-mini" dir="auto">
              <div class="flex w-full flex-col gap-1 empty:hidden first:pt-[3px]">
               <div class="markdown prose w-full break-words dark:prose-invert dark">
                <p data-end="804" data-start="0">
                 Website này, cùng với toàn bộ nội dung, thông tin và các yếu tố hình ảnh trên trang web, bao gồm nhưng không giới hạn các văn bản, thiết kế, đồ họa, giao diện, hình ảnh, video và mã nguồn, đều thuộc quyền sở hữu và bản quyền của
                 <strong data-end="251" data-start="229">
                  GREENFEED Việt Nam
                 </strong>
                 . Tất cả thông tin và nội dung có trên website này được bảo vệ bởi các quyền sở hữu trí tuệ theo quy định của pháp luật, và không được phép sao chép, in ấn, tái sử dụng hoặc sử dụng cho bất kỳ mục đích thương mại nào mà không có sự cho phép rõ ràng và bằng văn bản từ chúng tôi. Mọi hành vi xâm phạm bản quyền, bao gồm việc sao chép, phân phối hoặc sử dụng trái phép các nội dung trên website này, sẽ bị chúng tôi yêu cầu xử lý theo đúng quy định của pháp luật hiện hành và có quyền yêu cầu bồi thường thiệt hại nếu có vi phạm.
                </p>
                <p data-end="1533" data-start="806">
                 Các liên kết (links) được cung cấp trên website này chỉ nhằm mục đích tham khảo và tạo sự hữu ích tiện lợi cho người sử dụng khi tìm kiếm thông tin liên quan. Tuy nhiên, việc đưa các liên kết này không có nghĩa là
                 <strong data-end="1034" data-start="1012">
                  GREENFEED Việt Nam
                 </strong>
                 khuyến khích người đọc hoặc người dùng sử dụng các thông tin được chia sẻ qua các đường dẫn đó, và chúng tôi không chịu bất kỳ trách nhiệm nào đối với nội dung của các website hoặc tài liệu mà các liên kết này trỏ đến. Những trang web bên ngoài mà website của chúng tôi liên kết có thể có các điều khoản sử dụng, chính sách bảo mật và nội dung khác biệt, vì vậy chúng tôi không đảm bảo hoặc chịu trách nhiệm về tính chính xác, hợp pháp hay sự an toàn của các trang web đó.
                </p>
                <p data-end="2079" data-is-last-node="" data-is-only-node="" data-start="1535">
                 Tất cả các yếu tố liên quan đến nhãn hiệu thương mại, nhãn hiệu dịch vụ và tên thương mại xuất hiện trên trang web này, bao gồm logo, tên gọi và các yếu tố nhận diện khác, đều thuộc quyền sở hữu độc quyền của
                 <strong data-end="1766" data-start="1744">
                  GREENFEED Việt Nam
                 </strong>
                 và không được phép sao chép, mô phỏng hoặc sử dụng dưới bất kỳ hình thức nào mà không có sự chấp thuận chính thức từ công ty. Chúng tôi sẽ bảo vệ quyền sở hữu trí tuệ của mình và sẽ có hành động pháp lý thích hợp để ngừng các hành vi xâm phạm quyền lợi của mình liên quan đến bản quyền và nhãn hiệu.
                </p>
                <h2 data-end="9202" data-start="9191">
                 Liên hệ
                </h2>
                <p data-end="9383" data-start="9204">
                 Để biết thêm thông tin về các điều khoản sử dụng của chúng tôi, hoặc nếu bạn muốn khiếu nại, vui lòng liên hệ với chúng tôi qua email tại
                ...
                function isPhone(phone)
                    ...
                    function FormSubmit()
                    {
                        $('form.cooperate-form').submit(function(e) {
                            ...
                            {
                                                                var formData = form.serialize();
                                formData = formData+"&SubmitPlatform=Website&SourceMedium=" + 'Unknown'+"&current_url="+window.location.href+"&current_title=Điều khoản sử dụng - GREENFEED Việt Nam";
                                jQuery.ajax({
                                    url: 'https://www.greenfeed.com.vn/wp-admin/admin-ajax.php',
                                    type: "POST",
                                    data: formData,
                    ...
                    function Add2GSheet(data)
                    {
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                'Ngày liên hệ fanpage' :  '2025-11-01 13:01:29',
                                'Status' :  'chờ gọi',
     ...
     <div class="footer-bottom__menu">
      <div class="menu-footer-bottom-container">
       <ul class="dt-footer-bottom-menu footer-bottom-menu" id="footer-bottom">
        ...
        <li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-151 current_page_item active menu-item-4641 active active active active" id="menu-item-4641">
         <a href="index.php">
          <span>
           Điều khoản sử dụng
          </span>
  ...
  <link href="../wp-content/themes/greenfeed/assets/css/popup-cta5b0b.css?ver=61d1a2dd11eb8b52cccf5c2549d5e191411" id="popup_style-css" media="all" rel="stylesheet" type="text/css"/>
 ...
 <!-- Mirrored from www.greenfeed.com.vn/dieu-khoan-su-dung/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Nov 2025 06:08:09 GMT -->
</html>
