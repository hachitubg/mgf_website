...
<html lang="vi" prefix="og: https://ogp.me/ns#">
 <!-- Mirrored from www.greenfeed.com.vn/thuy-san/danh-muc-san-pham/dinh-duong-bo-sung/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Nov 2025 06:15:17 GMT -->
 <!-- Added by HTTrack -->
 ...
 <head>
  ...
  <link href="../../en/danh-muc-san-pham/supplementary-nutrition/index.php" hreflang="en" rel="alternate"/>
  <!-- Search Engine Optimization by Rank Math PRO - https://rankmath.com/ -->
  <title>
   Dinh dưỡng bổ sung - GREENFEED Thuỷ sản
  </title>
  <meta content="index, follow, max-snippet:-1, max-video-preview:-1, max-image-preview:large" name="robots">
   <link href="index.php" rel="canonical"/>
   <meta content="vi_VN" property="og:locale">
    <meta content="article" property="og:type"/>
    <meta content="Dinh dưỡng bổ sung - GREENFEED Thuỷ sản" property="og:title"/>
    <meta content="https://www.greenfeed.com.vn/thuy-san/danh-muc-san-pham/dinh-duong-bo-sung/" property="og:url"/>
...
:root :where(.wp-block-pullquote){font-size: 1.5em;line-height: 1.6;}
 ...
 <body class="archive tax-danh-muc-san-pham term-dinh-duong-bo-sung term-333 wp-theme-gf-thuysan loading-effect fade-in">
  <!-- Header -->
  <header id="dt-header">
             ...
             <div class="dt-dropdown-menu-wrapper">
              <ul class="dropdown-menu">
               <li class="menu-item-2956" id="menu-item-2956">
                <a href="../hoa-chat-xu-ly-nuoc/index.php">
                 <span>
                  Hoá chất xử lý nước
                 </span>
                </a>
               ...
               <li class="menu-item-2954" id="menu-item-2954">
                <a href="../che-pham-sinh-hoc-va-enzyme/index.php">
                 <span>
               ...
               <li class="menu-item-2957" id="menu-item-2957">
                <a href="../cai-thien-moi-truong/index.php">
                 <span>
                  Cải thiện môi trường
                 </span>
                </a>
               </li>
               <li class="active menu-item-2955" id="menu-item-2955">
                <a href="index.php">
                 <span>
                  Dinh dưỡng bổ sung
                 </span>
               ...
               <li class="menu-item-2966" id="menu-item-2966">
                <a href="../thuoc-phong-tri-benh/index.php">
                 <span>
      ...
      <div class="header-utility">
       <div class="header-utility__wrapper">
        ...
        <div class="header-utility__language">
         <a href="../../en/danh-muc-san-pham/supplementary-nutrition/index.php">
   ...
   <div class="container">
    <div class="dt-breadscrumb">
     <ul class="breadcrumb">
      ...
      <li>
       <a href="../cham-soc-suc-khoe-thuy-san/index.php">
        Chăm sóc sức khoẻ thuỷ sản
       </a>
      </li>
      <li>
       <a href="index.php">
    ...
    <div class="product-list">
     <div class="product-item" data-id="3263" data-slug="green-ferric">
      <a class="product-item__link">
       <div class="product-item__image">
        <img alt="" class="attachment-full size-full wp-post-image" decoding="async" fetchpriority="high" src="https://www.greenfeed.com.vn/thuy-san/wp-content/uploads/2025/02/PACK-GREEN-FERRIC.png">
        </img>
       </div>
     ...
     <div class="product-item" data-id="3258" data-slug="green-minerals">
      <a class="product-item__link">
       <div class="product-item__image">
     ...
     <div class="product-item" data-id="2941" data-slug="green-aqua-c">
      <a class="product-item__link">
       <div class="product-item__image">
     ...
     <div class="product-item" data-id="2935" data-slug="green-heal">
      <a class="product-item__link">
       <div class="product-item__image">
        <img alt="" class="attachment-full size-full wp-post-image" decoding="async" loading="lazy" src="https://www.greenfeed.com.vn/thuy-san/wp-content/uploads/2024/04/6.-GREEN-HEAL-copy.jpg">
        </img>
       </div>
       <div class="product-item__title-wrap">
        <h3 class="product-item__title">
     ...
     <div class="product-item" data-id="2927" data-slug="green-liver">
      <a class="product-item__link">
       <div class="product-item__image">
        <img alt="" class="attachment-full size-full wp-post-image" decoding="async" loading="lazy" src="https://www.greenfeed.com.vn/thuy-san/wp-content/uploads/2024/04/3.-GREEN-LIVER-copy.jpg"/>
       </div>
       <div class="product-item__title-wrap">
        <h3 class="product-item__title">
         <b>
     ...
     <div class="product-item" data-id="2921" data-slug="green-antistress">
      <a class="product-item__link">
       <div class="product-item__image">
        <img alt="" class="attachment-full size-full wp-post-image" decoding="async" loading="lazy" src="https://www.greenfeed.com.vn/thuy-san/wp-content/uploads/2024/04/1.-GREEN-ANTISTRESS-copy.jpg"/>
       </div>
       <div class="product-item__title-wrap">
        <h3 class="product-item__title">
         <b>
                ...
                function FormSubmit()
                {
                    $('form.cooperate-form').submit(function(e) {
                        ...
                        if(flag)
                        {
                            ...
                            formData = formData+"&SubmitPlatform=WebsiteTS&SourceMedium=" + 'Unknown'+"&current_url="+window.location.href+"&current_title=Dinh dưỡng bổ sung - GREENFEED Thuỷ sản"; 
                            jQuery.ajax({
                                url: 'https://www.greenfeed.com.vn/thuy-san/wp-admin/admin-ajax.php',
                                type: "POST",
                                data: formData,
                    ...
                    function Add2GSheet(data)
                    {
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                'Ngày liên hệ fanpage' :  '2025-11-01 13:04:00',
                                'Status' :  'chờ gọi',
