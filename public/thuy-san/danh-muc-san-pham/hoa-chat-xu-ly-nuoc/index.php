...
<html lang="vi" prefix="og: https://ogp.me/ns#">
 <!-- Mirrored from www.greenfeed.com.vn/thuy-san/danh-muc-san-pham/hoa-chat-xu-ly-nuoc/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Nov 2025 06:15:16 GMT -->
 <!-- Added by HTTrack -->
 ...
 <head>
  ...
  <link href="../../en/danh-muc-san-pham/disinfectants/index.php" hreflang="en" rel="alternate"/>
  <!-- Search Engine Optimization by Rank Math PRO - https://rankmath.com/ -->
  <title>
   Hoá chất xử lý nước - GREENFEED Thuỷ sản
  </title>
  <meta content="follow, index, max-snippet:-1, max-video-preview:-1, max-image-preview:large" name="robots">
   <link href="index.php" rel="canonical"/>
   <meta content="vi_VN" property="og:locale">
    <meta content="article" property="og:type"/>
    <meta content="Hoá chất xử lý nước - GREENFEED Thuỷ sản" property="og:title"/>
    <meta content="https://www.greenfeed.com.vn/thuy-san/danh-muc-san-pham/hoa-chat-xu-ly-nuoc/" property="og:url"/>
    ...
    <meta content="Hoá chất xử lý nước - GREENFEED Thuỷ sản" name="twitter:title"/>
...
:root :where(.wp-block-pullquote){font-size: 1.5em;line-height: 1.6;}
 ...
 <body class="archive tax-danh-muc-san-pham term-hoa-chat-xu-ly-nuoc term-327 wp-theme-gf-thuysan loading-effect fade-in">
  <!-- Header -->
  <header id="dt-header">
          ...
          <div class="dt-dropdown-menu-wrapper">
           <ul class="dropdown-menu">
            <li class="dropdown active menu-item-2951" id="menu-item-2951">
             ...
             <div class="dt-dropdown-menu-wrapper">
              <ul class="dropdown-menu">
               <li class="active menu-item-2956" id="menu-item-2956">
                <a href="index.php">
                 <span>
                  Hoá chất xử lý nước
                 </span>
               ...
               <li class="menu-item-2955" id="menu-item-2955">
                <a href="../dinh-duong-bo-sung/index.php">
                 <span>
                  Dinh dưỡng bổ sung
                 </span>
                </a>
      ...
      <div class="header-utility">
       <div class="header-utility__wrapper">
        ...
        <div class="header-utility__language">
         <a href="../../en/danh-muc-san-pham/disinfectants/index.php">
  ...
  <main class="site-main" id="dt-main-content" role="main">
   <div class="container">
    ...
    <div class="product-list">
     <div class="product-item" data-id="3260" data-slug="green-bronopol-5000">
      <a class="product-item__link">
       <div class="product-item__image">
        <img alt="" class="attachment-full size-full wp-post-image" decoding="async" fetchpriority="high" src="https://www.greenfeed.com.vn/thuy-san/wp-content/uploads/2025/02/PACK-GREEN-BRONOBOL.png">
        </img>
       </div>
     ...
     <div class="product-item" data-id="3255" data-slug="green-glutacide">
      <a class="product-item__link">
       <div class="product-item__image">
     ...
     <div class="product-item" data-id="3246" data-slug="green-iod-liq">
      <a class="product-item__link">
       <div class="product-item__image">
     ...
     <div class="product-item" data-id="3003" data-slug="dovidinefor-fish">
      <a class="product-item__link">
       <div class="product-item__image">
        <img alt="" class="attachment-full size-full wp-post-image" decoding="async" loading="lazy" src="https://www.greenfeed.com.vn/thuy-san/wp-content/uploads/2024/04/8.-DOVIDINE-FOR-FISH-copy.png">
        </img>
       </div>
       <div class="product-item__title-wrap">
        <h3 class="product-item__title">
     ...
     <div class="product-item" data-id="3001" data-slug="donacidefor-fish">
      <a class="product-item__link">
       <div class="product-item__image">
        <img alt="" class="attachment-full size-full wp-post-image" decoding="async" loading="lazy" src="https://www.greenfeed.com.vn/thuy-san/wp-content/uploads/2024/04/7.-DONACIDE-FOR-FISH-copy.png"/>
       </div>
       <div class="product-item__title-wrap">
        <h3 class="product-item__title">
         <b>
                ...
                function FormSubmit()
                {
                    $('form.cooperate-form').submit(function(e) {
                        ...
                        if(flag)
                        {
                            ...
                            formData = formData+"&SubmitPlatform=WebsiteTS&SourceMedium=" + 'Unknown'+"&current_url="+window.location.href+"&current_title=Hoá chất xử lý nước - GREENFEED Thuỷ sản"; 
                            jQuery.ajax({
                                url: 'https://www.greenfeed.com.vn/thuy-san/wp-admin/admin-ajax.php',
                                type: "POST",
                                data: formData,
