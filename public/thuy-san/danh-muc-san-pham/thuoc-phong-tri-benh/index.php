...
<html lang="vi" prefix="og: https://ogp.me/ns#">
 <!-- Mirrored from www.greenfeed.com.vn/thuy-san/danh-muc-san-pham/thuoc-phong-tri-benh/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Nov 2025 06:15:18 GMT -->
 <!-- Added by HTTrack -->
 ...
 <head>
  ...
  <link href="../../en/danh-muc-san-pham/antibiotics/index.php" hreflang="en" rel="alternate"/>
  <!-- Search Engine Optimization by Rank Math PRO - https://rankmath.com/ -->
  <title>
   Thuốc phòng trị bệnh - GREENFEED Thuỷ sản
  </title>
  <meta content="index, follow, max-snippet:-1, max-video-preview:-1, max-image-preview:large" name="robots">
   <link href="index.php" rel="canonical"/>
   <meta content="vi_VN" property="og:locale">
    <meta content="article" property="og:type"/>
    <meta content="Thuốc phòng trị bệnh - GREENFEED Thuỷ sản" property="og:title"/>
    <meta content="https://www.greenfeed.com.vn/thuy-san/danh-muc-san-pham/thuoc-phong-tri-benh/" property="og:url"/>
    ...
    <meta content="Thuốc phòng trị bệnh - GREENFEED Thuỷ sản" name="twitter:title"/>
...
:root :where(.wp-block-pullquote){font-size: 1.5em;line-height: 1.6;}
 ...
 <body class="archive tax-danh-muc-san-pham term-thuoc-phong-tri-benh term-335 wp-theme-gf-thuysan loading-effect fade-in">
  <!-- Header -->
  <header id="dt-header">
            ...
            <li class="dropdown active menu-item-2951" id="menu-item-2951">
             ...
             <div class="dt-dropdown-menu-wrapper">
              <ul class="dropdown-menu">
               ...
               <li class="active menu-item-2966" id="menu-item-2966">
                <a href="index.php">
                 <span>
      ...
      <div class="header-utility">
       <div class="header-utility__wrapper">
        ...
        <div class="header-utility__language">
         <a href="../../en/danh-muc-san-pham/antibiotics/index.php">
  ...
  <main class="site-main" id="dt-main-content" role="main">
   <div class="container">
    ...
    <div class="product-list">
     <div class="product-item" data-id="2998" data-slug="flor-f20">
      <a class="product-item__link">
       <div class="product-item__image">
        <img alt="" class="attachment-full size-full wp-post-image" decoding="async" fetchpriority="high" src="https://www.greenfeed.com.vn/thuy-san/wp-content/uploads/2024/04/10.-FLOR-copy.png">
        </img>
       </div>
     ...
     <div class="product-item" data-id="2993" data-slug="sulftrim-f">
      <a class="product-item__link">
       <div class="product-item__image">
                ...
                function FormSubmit()
                {
                    $('form.cooperate-form').submit(function(e) {
                        ...
                        if(flag)
                        {
                            ...
                            formData = formData+"&SubmitPlatform=WebsiteTS&SourceMedium=" + 'Unknown'+"&current_url="+window.location.href+"&current_title=Thuốc phòng trị bệnh - GREENFEED Thuỷ sản"; 
                            jQuery.ajax({
                                url: 'https://www.greenfeed.com.vn/thuy-san/wp-admin/admin-ajax.php',
                                type: "POST",
                                data: formData,
                    ...
                    function Add2GSheet(data)
                    {
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                'Ngày liên hệ fanpage' :  '2025-11-01 13:04:01',
                                'Status' :  'chờ gọi',
