...
<html lang="vi" prefix="og: https://ogp.me/ns#">
 <!-- Mirrored from www.greenfeed.com.vn/thuy-san/chuyen-muc/giai-phap-ky-thuat/ca-nuoc-ngot-khac/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Nov 2025 06:15:19 GMT -->
 <!-- Added by HTTrack -->
 ...
 <head>
  ...
  <title>
   Cá nước ngọt khác - GREENFEED Thuỷ sản
  </title>
  <meta content="index, follow, max-snippet:-1, max-video-preview:-1, max-image-preview:large" name="robots">
   <link href="index.php" rel="canonical"/>
   <meta content="vi_VN" property="og:locale">
    <meta content="article" property="og:type"/>
    <meta content="Cá nước ngọt khác - GREENFEED Thuỷ sản" property="og:title"/>
    <meta content="https://www.greenfeed.com.vn/thuy-san/chuyen-muc/giai-phap-ky-thuat/ca-nuoc-ngot-khac/" property="og:url"/>
    ...
    <meta content="Cá nước ngọt khác - GREENFEED Thuỷ sản" name="twitter:title"/>
...
:root :where(.wp-block-pullquote){font-size: 1.5em;line-height: 1.6;}
    ...
    <link href="https://www.greenfeed.com.vn/thuy-san/wp-json/wp/v2/categories/353" rel="alternate" title="JSON" type="application/json"/>
 ...
 <body class="archive category category-ca-nuoc-ngot-khac category-353 wp-theme-gf-thuysan loading-effect fade-in">
  <!-- Header -->
  <header id="dt-header">
         ...
         <li class="dropdown active menu-item-2893" id="menu-item-2893">
          ...
          <div class="dt-dropdown-menu-wrapper">
           <ul class="dropdown-menu">
            ...
            <li class="dropdown active menu-item-2952" id="menu-item-2952">
             <a class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown" href="#">
              <span>
               Giải pháp kỹ thuật
              </span>
             ...
             <div class="dt-dropdown-menu-wrapper">
              <ul class="dropdown-menu">
               <li class="menu-item-2962" id="menu-item-2962">
                <a href="../giong-thuy-san/index.php">
                 <span>
                  Giống thủy sản
                 </span>
                </a>
               ...
               <li class="menu-item-2959" id="menu-item-2959">
                <a href="../ca-ro-phi-dieu-hong/index.php">
                 <span>
                  Cá rô phi, điêu hồng
                 </span>
                </a>
               </li>
               <li class="active menu-item-2964" id="menu-item-2964">
                <a href="index.php">
                 <span>
                  Cá nước ngọt khác
                 </span>
               ...
               <li class="menu-item-2958" id="menu-item-2958">
                <a href="../ca-nuoc-lo-man/index.php">
                 <span>
                  Cá nước lợ, mặn
                 </span>
                </a>
                ...
                function FormSubmit()
                {
                    $('form.cooperate-form').submit(function(e) {
                        ...
                        if(flag)
                        {
                            ...
                            formData = formData+"&SubmitPlatform=WebsiteTS&SourceMedium=" + 'Unknown'+"&current_url="+window.location.href+"&current_title=Cá nước ngọt khác - GREENFEED Thuỷ sản"; 
                            jQuery.ajax({
                                url: 'https://www.greenfeed.com.vn/thuy-san/wp-admin/admin-ajax.php',
                                type: "POST",
                                data: formData,
                    ...
                    function Add2GSheet(data)
                    {
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                'Ngày liên hệ fanpage' :  '2025-11-01 13:04:04',
                                'Status' :  'chờ gọi',
